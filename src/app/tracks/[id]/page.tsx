              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                {track.events.length > 0 && (
                  <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="space-y-4">
                      {track.events.map((event: typeof track.events[number]) => (
                        <div
                          key={event.id}
                ...
                {track.announcements.length > 0 && (
                  <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <div className="space-y-4">
                      {track.announcements.map((announcement: typeof track.announcements[number]) => (
                  ...
                  {track.students.length > 0 ? (
                    <>
                      <div className="grid grid-cols-4 gap-3 mb-4">
                        {track.students.map((enrollment: typeof track.students[number]) => (
